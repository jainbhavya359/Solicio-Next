  ...
  return (
    <div className="min-h-screen bg-[#F7FAF9] flex overflow-x-hidden w-full">
      ...
      >
        ...
        {/* Navigation */}
        <nav className="flex-1 px-3 lg:px-3 mt-2 overflow-y-auto overflow-x-hidden">
          <p className="px-4 lg:px-6 mb-2 lg:mb-3 text-[9px] lg:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] transition-opacity duration-300 lg:opacity-0 lg:group-hover:opacity-100 whitespace-nowrap">Menu Navigation</p>
          <div className="space-y-1 lg:space-y-1.5 shrink-0">
            <motion.a
              href="/"
              className="w-full flex items-center justify-between px-4 lg:px-3 py-2.5 lg:py-3 rounded-2xl transition-all duration-200 text-slate-600 hover:bg-slate-50 border border-transparent hover:border-slate-100 hover:text-emerald-600 overflow-hidden"
              whileHover={{ x: 2 }}
            >
              <div className="flex items-center gap-3 shrink-0">
            ...
            <motion.a
              href="/features"
              className="w-full flex items-center justify-between px-4 lg:px-3 py-2.5 lg:py-3 rounded-2xl transition-all duration-200 text-slate-600 hover:bg-slate-50 border border-transparent hover:border-slate-100 overflow-hidden"
              whileHover={{ x: 2 }}
            >
              <div className="flex items-center gap-3 shrink-0">
                <div className="w-8 flex items-center justify-center shrink-0 text-slate-500">
                  {Icons.features}
                </div>
            ...
            <p className="px-4 lg:px-6 mb-2 lg:mb-3 text-[9px] lg:text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] transition-opacity duration-300 lg:opacity-0 lg:group-hover:opacity-100 whitespace-nowrap">Insights & Control</p>
            ...
            {navItems.map((item) => (
              ...
              >
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <span className="font-bold text-sm transition-opacity duration-300 lg:opacity-0 lg:group-hover:opacity-100 whitespace-nowrap">{item.label}</span>
                </div>
                {activeSection === item.id && (
                  <motion.span
        ...
        {/* User Section */}
        <div className="py-3 px-3 lg:py-4 lg:px-3 shrink-0">
          <div className="bg-slate-50 rounded-[28px] lg:rounded-[24px] p-2 lg:p-1 border border-slate-100 overflow-hidden">
            <div className="flex items-center gap-3 lg:gap-3 p-2 lg:p-1 rounded-2xl bg-white border border-slate-100 shadow-sm shrink-0 overflow-hidden w-full">
